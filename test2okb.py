...
def send_okx_ws_auth(ws_instance):
    ...
    """
    try:
        # Use a Unix timestamp string for WebSocket authentication
        timestamp_s = str(time())

        # The message for WebSocket authentication is timestamp + "GET" + "/users/self/verify"
